...
namespace mySLAM {
    ...
    void Backend::BackendLoop() {
        while (backend_running_.load()) {
            ...
            // backend only optimizes activated Frames and Landmarks
    ...
    void Backend::Optimize(Map::KeyframesType &keyframes,
        ...
        // K, and left & right extrinsic params
        Mat33 K = cam_left_->K();
        ...
        map<EdgeProjection *, Feature::Ptr> edges_and_features;
        ...
        for (auto &landmark:landmarks) {
            ...
            for (auto &obs:observations) {
                ...
                // If the landmark not added to optimization, add new vertex
