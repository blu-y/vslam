...
inline void AngleAxisToQuaternion(const T *angle_axis, T *quaternion) {
    ...
    if (theta_squared > T(numeric_limits<double>::epsilon())) {
...
inline void AngleAxisRotatePoint(const T angle_axis[3], const T pt[3], T result[3]) {
    ...
    if (theta2 > T(numeric_limits<double>::epsilon())) {
        // Away from zero, use the rodrigues fomula
        //
        //  result = pt costheta +
        //           (w x pt) * sintheta +
        //           w(w . pt) (1- costheta)
