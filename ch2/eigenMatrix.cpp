...
int main(int argc, char **argv) {
    ...
    //  you can use a matrix of dynamic size
    ...
    //  like this is wrong, Matrix<double, 2, 1> result_wrong_type = matrix_23 * v_3d;
    ...
    // Try cancelling the comments below to see what Eigen will report.
    ...
    // The size of N is defined in the previous macro,
    //  which is generated by a random number Direct inversion is the most direct,
    //  but the amount of inverse operations is large.
    ...
    cout << "time of normal inverse is " << 1000 * (clock() - time_stt) / static_cast<double>(CLOCKS_PER_SEC) << " ms" << endl;
    cout << "x = " << x.transpose() << endl;

    // For positive definite matrices, you can also use cholesky decomposition to solve equations.
    time_stt = clock();
    x = matrix_NN.ldlt().solve(v_Nd);
    cout << "time of ldlt decomposition is " << 1000 * (clock() - time_stt) / static_cast<double>(CLOCKS_PER_SEC) << " ms" << endl;
    cout << "x = " << x.transpose() << endl;
